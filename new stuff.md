...
- make the cli able to query a server and also spin a up a web server with a rps server scanner with "swagger" interface for found server, including dialog to send rpc calls and see the results / events